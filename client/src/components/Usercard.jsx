...
function Usercard() {
  return (
    <div className='flex flex-col rounded-2xl border border-gray-200 relative gap-4 overflow-hidden bg-[#ffffffa3] pb-2  shadow-[#ff9a3b] shadow-soft hover:-translate-y-1 transition-all ease-in-out'>
